...
IMPORTLIST_TYPE_MAP = {
    importlist_type.__private_attributes__["_implementation"].default: importlist_type
...
class RadarrListsSettings(RadarrConfigBase):
    ...
    def from_remote(cls, secrets: RadarrSecrets) -> Self:
        ...
        return cls(
            **cls.get_local_attrs(cls.__private_attributes__["_remote_map"].default, api_importlist_config_dict),
